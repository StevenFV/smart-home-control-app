            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <div>
                    ...
                    <Link
                        ...
                        method="post"
                        is="button"
                        class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800 ms-2"
                    >
                        Log Out
                    </Link>
                </div>

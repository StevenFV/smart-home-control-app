...
expect()->extend('toBeValidIeeeAddress', function () {
    ...
    expect($isValidFormat)->toBeTrue(sprintf(Message::TO_BE_VALID_IEEE_ADDRESS->value, $this->value));
...
expect()->extend('toBeValidfriendlyName', function () {
    ...
    expect($isValidFormat)->toBeTrue(sprintf(Message::TO_BE_VALID_FRIENDLY_NAME->value, $this->value));
